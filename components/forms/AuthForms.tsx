...
const inputClass = "mt-1 h-11 w-full rounded-md border border-audit-border px-3 text-base outline-none focus:border-zinc-500 focus:ring-2 focus:ring-zinc-200";
...
export function SetupForm() {
  ...
  return (
    <form className="space-y-4" onSubmit={onSubmit}>
      ...
      <label className="block text-sm font-medium">Email<input className={inputClass} name="email" type="email" autoComplete="email" required /></label>
      <label className="block text-sm font-medium">Password<input className={inputClass} name="password" type="password" autoComplete="new-password" minLength={12} required /><span className="mt-1 block text-xs text-audit-muted">At least 12 characters with uppercase, lowercase, and a number.</span></label>
      <Status state={state} />
