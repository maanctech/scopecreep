...
export const DEMO_COMPANY_ID = "11111111-2222-4333-8444-555555555555";
export const DEMO_LEAD_ID = "aaaaaaaa-1111-4111-8111-111111111111";
export const DEMO_AUDIT_REQUEST_ID = "bbbbbbbb-2222-4222-8222-222222222222";
export const DEMO_PROJECT_ID = "22222222-2222-4222-8222-222222222222";

export const SAMPLE_SOW = `Northstar Digital Studio will redesign and build the public marketing website for ApertureOps, a B2B SaaS company, for a fixed project fee of $48,000.
...
export const createdAt = "2026-06-05T12:00:00.000Z";
