...
export default function AppError({
  ...
  return (
    <div className="rounded-md border border-red-200 bg-red-50 p-8" role="alert">
      ...
      <p className="mt-2 max-w-2xl text-base leading-7 text-red-800">
        {error.message ||
      ...
      <button
        type="button"
        onClick={reset}
        className="mt-4 inline-flex h-11 items-center rounded-md bg-ink px-5 text-sm font-semibold text-white hover:bg-zinc-800"
      >
        Try again
      </button>
    </div>
